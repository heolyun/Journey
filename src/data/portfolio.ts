...
export const featuredProjects: FeaturedProject[] = [
  ...
  },
  {
    ...
    title: 'AntiADHD',
    status: 'In Progress',
    category: 'Mobile Product · On-premise Kubernetes',
    stack: ['React Native', 'Spring Boot', 'k3s', 'Kustomize', 'Prometheus · Grafana'],
  ...
  },
  {
    ...
    title: 'MindOff',
    status: 'In Progress',
    category: 'AWS Cloud Architecture · Life Assistant',
    stack: ['React Native', 'Spring Boot', 'PostgreSQL', 'AWS Architecture'],
